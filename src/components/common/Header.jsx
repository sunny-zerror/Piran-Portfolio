...
const pn = [[.45, .85], [.38, .88], [.31, .88], [.24, .84], [.18, .78], [.17, .71], [.22, .66], [.16, .61], [.12, .55], [.10, .48], [.11, .41], [.15, .35], [.22, .32], [.24, .24], [.29, .17], [.37, .13], [.45, .15], [.45, .25], [.39, .22], [.34, .25], [.29, .31], [.34, .25], [.39, .22], [.45, .35], [.45, .45], [.38, .42], [.31, .45], [.24, .52], [.31, .45], [.38, .42], [.45, .55], [.45, .65], [.37, .68], [.30, .73], [.25, .79], [.30, .73], [.37, .68], [.45, .75], [.45, .85], [.55, .85], [.55, .75], [.55, .65], [.63, .68], [.70, .73], [.75, .79], [.70, .73], [.63, .68], [.55, .55], [.55, .45], [.62, .42], [.69, .45], [.76, .52], [.69, .45], [.62, .42], [.55, .35], [.55, .25], [.61, .22], [.66, .25], [.71, .31], [.66, .25], [.61, .22], [.55, .15], [.63, .13], [.71, .17], [.76, .24], [.78, .32], [.85, .35], [.89, .41], [.90, .48], [.88, .55], [.84, .61], [.78, .66], [.83, .71], [.82, .78], [.76, .84], [.69, .88], [.62, .88], [.55, .85]];
        ...
        <div
          ...
          className={`px-4 py-2 pl-3 pointer-events-auto flex flex-col border border-white/10 rounded-lg justify-between w-full bg-transparent text-white
            transition-all duration-500 ease-out ${(isScrolled || isForcedScrolled || isAiOpen)
              ? isAiOpen
                ? 'md:max-w-3xl lg:max-w-xl bg-[#0B1A2C]! pb-3'
                : 'md:max-w-3xl lg:max-w-xl bg-[#0B1A2C]!'
              ...
              {navLinks.map((item, i) => (
                ...
                >
                  ...
                  <div className="relative">
                    {item.label}
                    <div
                      className={`absolute bottom-0 left-0 w-full h-px bg-white transition-transform duration-300 rounded-full ${pathname === item.href
                        ? "scale-x-100"

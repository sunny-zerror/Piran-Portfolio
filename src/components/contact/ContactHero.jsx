...
import HandParticlesCanvas from './HandParticlesCanvas';
...
const ContactHero = () => {
    ...
    return (
        <section ref={sectionRef} className="w-full md:h-[200vh] bg-[#0B1A2C] z-0">
            <div className="md:sticky! top-0 md:h-screen! z-10">
                <div ref={contentRef} className="container flex flex-col justify-end pb-12 md:pb-24 z-99">
                ...
                <div className="w-full hidden md:block absolute bottom-0 pointer-events-none ascii_hand_parent">
                    <HandParticlesCanvas />
                </div>
            </div>
            <SuccessPopup

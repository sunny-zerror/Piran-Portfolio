...
const Partners = () => {
    ...
    return (
        <div className="container bg-[#141d26]  text-white font-sans relative h-[200vh]!">
            ...
            <div className=" pt-24 bg-[#141d26] z-10 relative h-screen">
                <div className="grid gap-x-20 grid-cols-3">
                ...
                <div className="w-full col-span-2  items-start content-start grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
                    {growthPartnersData.map((item) => (
                        ...
                        >
                            {/* Placeholder for Logo */}
                            <div className="w-16 h-8 bg-white/5 rounded flex items-center justify-center">
                                <span className="text-white/20 text-xs">Logo</span>
                            </div>
                        </div>
                    ))}
            ...
            >
                {/* Modal Content */}
                <div
                    className="bg-white text-black w-full max-w-2xl rounded-3xl overflow-hidden relative flex flex-col max-h-[85vh] shadow-2xl"
                    onClick={(e) => e.stopPropagation()} // Prevent clicks inside modal from closing it
                >
                    {/* Scrollable area */}
                    <div className="p-6 overflow-y-auto custom-scrollbar">

                        <div className="bg-[#18253210] rounded-2xl p-6">
                            {/* Logo & Header */}
                        ...
                        <div>
                            ...
                            <div className={`grid transition-all duration-300 ease-in-out ${isDescOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                                <div className="overflow-hidden">
                                    <div className=" text-[#182532] opacity-70 leading-tight space-y-4  pt-1">
